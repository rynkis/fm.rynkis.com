        ...
        <div id='player-container'>
          ...
          <div id='player-panel'>
            ...
            <div id='controller' data-id='fa-over'>
              <div className='item' data-id='fa-github'>
                <a className='fa-button'>
                  <i className='fa fa-github' title='Home'/>
                </a>
              </div>
              <div className='item' data-id='fa-back'>
                <a className='fa-button'>
                  <i className='fa fa-skip-back' title='Prev'/>
                </a>
              </div>
              <div className='item' data-id='fa-play'>
                <a className='fa-button fa-button-prime'>
                  <i className='fa fa-play' title='play'/>
                </a>
              </div>
              <div className='item' data-id='fa-over'>
                <a className='fa-button'>
                  <i className='fa fa-skip-forward' title='Next'/>
                </a>
              </div>
